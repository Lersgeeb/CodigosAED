myFile = open("MyTxtFile")  #Inicializar el archivo de texto
...
with open("MyTxtFile") as myNewFile: #Otra forma de abrir un archivo de texto que lo cierra
                                     #automaticamente una vez fuera del bloque
    content = myNewFile.read()
    print(content)

with open("MyTxtFile",mode = "a") as myNewFile2: #w: escribir sobre un archivo
                                        #r: leer el archivo
...
with open("MyTxtFile","w") as myNewFile3:
    myNewFile3.write("\nmi quinta linea")    
